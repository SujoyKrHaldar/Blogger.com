function ArticleSkeletonUI() {
  return (
    <section className="py-32 space-y-14 fixed inset-0 z-40 bg-white opacity-80">
      <div className="container">
        <div className="space-y-3">
          ...
          <div className="max-w-[250px] h-[43px] mx-auto bg-gray-300 animate-pulse rounded-xl"></div>
        </div>
      </div>
